...
function MainPage() {
  return (
    <>
        <div className='bg-gray-900 h-screen p-[20px] flex justify-center'>
          <div className='max-w-300'>
            ...
            <p className='text-center font-normal text-gray-400 mb-5'>Easily convert currencies in real-time 
